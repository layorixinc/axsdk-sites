...
export const COMMANDS = {
  ...
  install: {
    usage: '/install <profile> [--merge] [--no-build]', help: 'build the extension, then attach/refresh it and turn on both toggles', takes: 'name', flags: { merge: 'switch', 'no-build': 'switch' },
  },
  uninstall: {
